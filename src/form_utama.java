...
public class form_utama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("APLIKASI PERPUSTAKAAN By : Nama");

        jLabel13.setFont(new java.awt.Font("Yu Mincho", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("NIM : XXXXXXXXXX");
  ...
  public void jamDigital() {
    ...
    public void tampil_tb_peminjaman(){
        Object []baris = {"no_dp","Nama","Jurusan","Kode Buku","Judul Buku","Tanggal Terbit","Tanggal Pinjam"};
        tabmode = new DefaultTableModel(null, baris);
        ...
        try {
            ...
            java.sql.ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
                String nim = hasil.getString("no_bp");
